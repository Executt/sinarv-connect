import { LayoutDashboard, Route, ClipboardCheck, AlertTriangle, Recycle, LogOut, ChevronLeft, ChevronRight, X, Users, BarChart3, Trash2, Radio, Coins } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Sustentabilidade", icon: Coins, url: "/dashboard/sustentabilidade" },
